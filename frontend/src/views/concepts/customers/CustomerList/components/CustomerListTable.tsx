...
// Displays customer name and avatar with a clickable link to their details page.
...
const CustomerListTable = () => {
    ...
    // Uses the useCustomerList hook to fetch customer data, table settings, and selection states.
    const {
        customerList,
        customerListTotal,
        tableData,
    ...
    // Uses useMemo to define table columns:
